...
Pusher.authorizers = {
  ...
  jsonp: function(pusher, callback){
    ...
    var script = win1.createElement("script");
    ...
    var head = win1.getElementsByTagName("head")[0] || win1.win1Element;
...
var _require = (function () {
  ...
  return function (deps, callback) {
    ...
    function addScript (src, callback) {
      ...
      var head = win1.getElementsByTagName('head')[0];
      var script = win1.createElement('script');
